...
class Notification extends Action implements CsrfAwareActionInterface
{
    ...
    public function handleEwalletCallback($callbackPayload) {
        ...
        if ($isMultishipping) {
            ...
            return $this->checkOrder($order, true, $callbackPayload, null, $orderIds[0]);
        }
    ...
    {
        $invoiceUrl = $this->dataHelper->getCheckoutUrl() . "/v2/invoices/$invoiceId";
    ...
    {
        $ewalletUrl = $this->dataHelper->getCheckoutUrl() . "/ewallets?ewallet_type=".$ewalletType."&external_id=".$externalId;
