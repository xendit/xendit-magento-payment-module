...
{
    /**
     * @var \Xendit\M2Invoice\External\Serialize\Serializer\Base64Json
     */
    private $base64json;
    ...
    protected function setUp()
    {
        ...
        $this->base64json = $objectManager->getObject(\Xendit\M2Invoice\External\Serialize\Serializer\Base64Json::class, [
            'jsonSerializer' => new \Xendit\M2Invoice\External\Serialize\Serializer\Json()
        ]);
    }
