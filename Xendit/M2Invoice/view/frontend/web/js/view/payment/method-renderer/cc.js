    ...
    function (
        ...
        return Component.extend({
            ...
            getCcAvailableTypes: function() {
                return window.checkoutConfig.payment.xendit.available_types['cc'];
            },

            getCcMonths: function() {
                return window.checkoutConfig.payment.xendit.months['cc'];
            },
 
            getCcYears: function() {
                return window.checkoutConfig.payment.xendit.years['cc'];
            },
 
            hasVerification: function() {
                return window.checkoutConfig.payment.xendit.has_verification;
            },
            ...
            placeOrder: function (data, event) {
                ...
                var self = this;
                var publicKey = window.checkoutConfig.payment.xendit.public_api_key;
