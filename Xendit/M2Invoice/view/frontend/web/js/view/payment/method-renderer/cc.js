        ...
        return Component.extend({
            ...
            validate: function() {
                ...
                if (totals.grand_total < 10000) {
                    self.messageContainer.addErrorMessage({'message': 'The minimum amount for using this payment is IDR 5,000. Please put more item(s) to reach the minimum amount.'});
                    return false;
                }
